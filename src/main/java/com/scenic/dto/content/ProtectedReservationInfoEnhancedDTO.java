 ...
 * 保护区介绍增强DTO类（包含发布人信息）
 */
public class ProtectedReservationInfoEnhancedDTO {
    private Long id;
    ...
    private String creatorName; // 创建人姓名（发布人）

    // 构造函数
    public ProtectedReservationInfoEnhancedDTO() {}
    ...
    public String toString() {
        return "ProtectedReservationInfoEnhancedDTO{" +
                "id=" + id +
                ", title='" + title + '\'' +
